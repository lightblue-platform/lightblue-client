...
public class LightblueClientMetadataTest {
	...
	@Test
	public void testGetAllMetadata() throws JSONException {
		...
		JSONAssert.assertEquals("{\"entities\":[\"termsAcknowledgement\",\"terms\"]}",response, false);
	}
	
	@Test
	public void testGetTermsMetadata() throws JSONException {
		LightblueClient client = new LightblueClient();
		LightblueRequest request = new MetadataRequest();
		request.setEntityName("terms");
		String response = client.metadata(request);
		JSONAssert.assertEquals("[{\"version\":\"0.8.0-SNAPSHOT\",\"changelog\":\"Initial version\",\"extendsVersions\":[],\"status\":\"active\",\"defaultVersion\":false},{\"version\":\"0.9.0-SNAPSHOT\",\"changelog\":\"Initial version\",\"extendsVersions\":[],\"status\":\"active\",\"defaultVersion\":false},{\"version\":\"0.10.0-SNAPSHOT\",\"changelog\":\"Initial version\",\"extendsVersions\":[],\"status\":\"active\",\"defaultVersion\":false},{\"version\":\"0.11.0-SNAPSHOT\",\"changelog\":\"Initial version\",\"extendsVersions\":[],\"status\":\"active\",\"defaultVersion\":false},{\"version\":\"0.12.0-SNAPSHOT\",\"changelog\":\"Initial version\",\"extendsVersions\":[],\"status\":\"active\",\"defaultVersion\":false},{\"version\":\"0.13.0-SNAPSHOT\",\"changelog\":\"Initial version\",\"extendsVersions\":[],\"status\":\"active\",\"defaultVersion\":false},{\"version\":\"0.14.0-SNAPSHOT\",\"changelog\":\"Initial version\",\"extendsVersions\":[],\"status\":\"active\",\"defaultVersion\":false},{\"version\":\"0.14.1-SNAPSHOT\",\"changelog\":\"Initial version\",\"extendsVersions\":[],\"status\":\"active\",\"defaultVersion\":false},{\"version\":\"0.14.2-SNAPSHOT\",\"changelog\":\"Initial version\",\"extendsVersions\":[],\"status\":\"active\",\"defaultVersion\":false},{\"version\":\"0.15.0-SNAPSHOT\",\"changelog\":\"Initial version\",\"extendsVersions\":[],\"status\":\"active\",\"defaultVersion\":true}]", response, false);
		Assert.assertNotNull(response);
	}
	
	@Test
	public void testGetTermsVersionMetadata() throws JSONException {
		LightblueClient client = new LightblueClient();
		LightblueRequest request = new MetadataRequest();
		request.setEntityName("terms");

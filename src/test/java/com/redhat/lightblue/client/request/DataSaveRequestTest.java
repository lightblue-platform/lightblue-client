...
public class DataSaveRequestTest {
    ...
    @Test
    public void testRequestHasDataSaveRequestType() {
        DataSaveRequest request = new DataSaveRequest(TEST_ENTITY_NAME, TEST_ENTITY_VERSION);
        assertEquals(RequestType.DATA_SAVE, request.getRequestType());
    }

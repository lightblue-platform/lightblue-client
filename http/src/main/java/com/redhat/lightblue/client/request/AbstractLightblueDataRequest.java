...
public abstract class AbstractLightblueDataRequest extends AbstractLightblueRequest implements LightblueRequest {
	...
	public static String PATH_PARAM_INSERT = "";
	public static String PATH_PARAM_SAVE = "save";
	public static String PATH_PARAM_UPDATE = "update";
	public static String PATH_PARAM_DELETE = "delete";
	public static String PATH_PARAM_FIND = "find";

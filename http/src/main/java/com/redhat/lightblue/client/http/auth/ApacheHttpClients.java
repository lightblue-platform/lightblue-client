...
public abstract class ApacheHttpClients {
     ...
     * client terms:
     *
     * <blockquote>Indicates the maximum number of connections per destination
     * to be kept alive at any given time</blockquote>
     *
     * @see
     * <a href="http://docs.oracle.com/javase/7/docs/technotes/guides/net/http-keepalive.html">HTTP

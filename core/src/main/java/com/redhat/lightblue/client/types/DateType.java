 ...
 */
package com.redhat.lightblue.client.types;
...
public final class DateType implements Type, Serializable {
    ...
    public Object fromJson(JsonNode node) {
        if (node.isValueNode()) {
            ...
            throw new RuntimeException("Object is not a ValueNode");
        }
    }
    ...
    public Object cast(Object obj) {
        ...
        if (obj != null) {
            ...
            if (obj instanceof Date) {
            	...
            	throw new RuntimeException("Object is not an instance of date");
            }
        }
        return value;
    }
